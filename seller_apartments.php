...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // JavaScript confirmation prompt for delete
    ...
    <script>
        function confirmDelete(apartment_id) {
            if (confirm("Are you sure you want to delete this apartment?")) {
                window.location.href = "delete_apartment.php?id=" + apartment_id; // Continue delete process
            } else {
                window.location.href = "seller_apartments.php"; // Cancel delete process
            }
        }
    </script>
